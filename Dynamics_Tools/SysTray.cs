...
namespace DynamicsTools
{
    ...
    #region SysTray
    /// <summary>
    /// Permite a un fomulario crear un systray en la taskBar
    /// OJO, que en XP y 2000 tiene que estar habilitados
    /// </summary>
        ...
        */
            ...
            )
        {
            if (this.inSysTray)
            {
                ...
                int ret = Shell_NotifyIcon(NotifyIconMessages.NIM_MODIFY, ref ids);
            }
            else
            {
